...
import petitdejuner from "../constants/petitdejuner";
const { width } = Dimensions.get("screen");

const thumbMeasure = (width - 48 - 32) / 3;
const cardWidth = width - theme.SIZES.BASE * 2;

class Ptdej extends React.Component {
      ...
      <Block flex style={styles.group}>
        ...
        <Block flex>
          <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
            ...
            <Petitdej item={petitdejuner[1]} full />
            <Petitdej item={petitdejuner[2]} full />

            
            <Petitdej item={petitdejuner[3]} full />
